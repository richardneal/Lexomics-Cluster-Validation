...
logFile <- ""
#write("3000 \n", file = logFile)
result <- myCluster("fedpapers.tsv", outputFilename = "dummy.png", nboot=10000, distMetric = "euclidean", runParallel = TRUE, input.transposed = TRUE, numCPUs = 2, clusterType = "SOCK", plotOut=FALSE, logFileName = logFile, metadata=FALSE)
